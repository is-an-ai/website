        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              The easiest way to get a subdomain for your AI project. No GitHub
              knowledge, no DNS configuration, no hassle.
            </p>
            ...
            <div className="max-w-md mx-auto mb-8">
              <div className="flex items-center bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                />
                <span className="px-4 text-lg text-gray-500 font-medium">
                  .is-an.ai
                </span>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We make subdomain registration simple for AI researchers and
              developers
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Get your subdomain in minutes, not hours. Our automated system
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                No need to understand DNS, GitHub, or domain configuration. Just
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Built on robust infrastructure with proper SSL certificates and
                DNS management.
              </p>
            </div>
          </div>
      ...
      <section className="py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join hundreds of AI projects already using is-an.ai subdomains
          </p>
          <button className="inline-flex items-center px-8 py-4 bg-white text-blue-600 font-semibold rounded-xl hover:bg-gray-50 transition-colors shadow-lg">
